	...
	<div id="container">
		...
		<div class="middle">
			<div id="main_container">
                ...
                <form id="cadastro_fabricante">
                    <div class="full-box">
                        <label for="nome">Nome</label>
                        <input type="text" name="nome" id="nome" placeholder="Digite nome do fabricante">
                    </div>
                    ...
                    <div class="half-box">
                        ...
                        <input type="text" name="cnpj" id="cnpj" placeholder="Digite CNPJ do fabricante">
                    </div>
                    <div class="full-box">
                        <label for="endereco">Endereço</label>
                        <input type="text" name="endereco" id="endereco" placeholder="Digite o endereço do fabricante">
                    </div>
                    <div class="half-box spacing">
                        <label for="numero">Número</label>
                        <input type="number" name="numero" id="numero" placeholder="Digite número do endereço">
                    </div>
                    <div class="half-box">
                        <label for="bairro">Bairro</label>
                        <input type="text" name="bairro" id="bairro" placeholder="Digite bairro do endereço">
                    </div>
                    <div class="half-box spacing">
                        <label for="cep">CEP</label>
                        <input type="text" name="cep" id="cep" placeholder="Digite CEP do endereço">
                    </div>
                    <div class="half-box">
                        <label for="cidade">Cidade</label>
                        <input type="text" name="cidade" id="cidade" placeholder="Digite cidade do endereço">
                    </div>
